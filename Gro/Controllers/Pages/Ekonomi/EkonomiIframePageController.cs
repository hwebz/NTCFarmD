...
{
    public class EkonomiIframePageController : PageController<EkonomiIFramePage>
    {
        ...
        public ActionResult Index(EkonomiIFramePage currentPage)
        {
            ...
            return View("Index", new PageViewModel<EkonomiIFramePage>(currentPage));
        }
    }
}