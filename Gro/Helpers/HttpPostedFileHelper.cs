    ...
    public static class HttpPostedFileBaseExtensions
    {
        ...
        public static bool IsImage(this HttpPostedFileBase postedFile, int imageMaximumBytes)
        {
            ...
            try
            {
                ...
                if (imageMaximumBytes > ImageMinimumBytes && postedFile.ContentLength > imageMaximumBytes)
                {
                    return false;
                }
        ...
        public static byte[] ReadAsByteArray(this HttpPostedFileBase postedFile)
        {
